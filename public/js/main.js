...
$(window).scroll(function () {
    ...
    if (ScrollingBody >= $("#namaHotel").offset().top - 130 && ScrollingBody < $("#Reviews").offset().top - 160) {
    ...
    } else if (ScrollingBody > $("#Reviews").offset().top - 150) {
...
$('#navlink').click(function (event) {
    ...
    $('html,body').animate({
        scrollTop: toElement.offset().top - 160
    }, 1000)
