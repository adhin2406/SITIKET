...
<div class="pcversion1 px-0 d-none d-lg-block" style="height: fit-content;">
    <nav class="navbar navbar-expand-lg navbar-light setting shadow  fixed-top">
        <div class="container">
            <a class="navbar-brand" href="<?= base_url() ?>/Tampilan/notif">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <ul class="list-unstyled mydetail">
                                <li class="media">
                                    <div class="media-body">
                                        <h5 class="mt-0 mb-1 tanggal"><?= date("l d M Y", strtotime($kendaraan['tanggal_berangkat'])) ?></h5>
                                    </div>
                                </li>
                                <li class="media my-4">
                                    <div class="media-body">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p>
                            <?= $kendaraan['rute_awal'] ?> - <?= date('h:i A', strtotime($kendaraan['takeOff'])); ?>
                        </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="rute">
                            <?= $kendaraan['rute_akhir'] ?> - <?= date('h:i A', strtotime($kendaraan['landing'])); ?>
                        </p>
                    </div>
                </div>
            </div>
